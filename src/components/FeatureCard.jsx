            ...
            <div className="relative z-10 lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
              <div className="mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2">
                <h2 className="text-2xl text-gray-800 font-bold sm:text-3xl dark:text-gray-200">
                  "Your Trusted Partner in Urine Strip Analysis"
                </h2>
                {/* Tab Navs */}
                <nav
                    ...
                    <span className="flex">
                      ...
                      <span className="grow ml-6">
                        ...
                        <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                          Our web app is designed to simplify and enhance the
                          process of identifying and understanding the colors on
                          your urine strip.{" "}
                        </span>
                      </span>
                    </span>
                  ...
                  >
                    <span className="flex">
                      ...
                      <span className="grow ml-6">
                        ...
                        <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                          Gain a deeper understanding of your health by
                          deciphering the color indicators on your urine strip.
                        </span>
                      </span>
                    </span>
                  </button>
                  ...
                  >
                    <span className="flex">
                      ...
                      <span className="grow ml-6">
                        ...
                        <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                          We prioritize your data security and privacy. Your
                          uploaded images are handled with the utmost care and
                          confidentiality.
                        </span>
                      </span>
                    </span>
